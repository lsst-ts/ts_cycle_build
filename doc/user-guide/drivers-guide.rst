...
A revision is considered a regular upgrade as non interface changes are done here.
An incremental release is considered a partial major upgrade as schema compatible changes can be done here.
...
.. tab-set::
    ...
    .. tab-item:: Incremental Release
        ...
        #. Open a new revision and update the ts-xml version.
        ...
        #. Once they confirm things are working, close the release using the normal process.
