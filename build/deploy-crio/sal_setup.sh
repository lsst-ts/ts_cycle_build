...
export SAL_WORK_DIR=$LSST_SDK_INSTALL/
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CONDA_PREFIX/lib:$SAL_WORK_DIR/lib
export LIBRARY_PATH=$SAL_WORK_DIR/lib
...
export LSST_KAFKA_SECURITY_PROTOCOL=${LSST_KAFKA_SECURITY_PROTOCOL}
export LSST_KAFKA_SECURITY_MECHANISM=${LSST_KAFKA_SECURITY_MECHANISM}
